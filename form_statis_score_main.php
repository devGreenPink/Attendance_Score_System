...
if($rs->num_rows>0)
{
    while($row=$rs->fetch_assoc())
    {
            ...
            echo "<td>".$row["term"]."</td>\n";
            echo "<td>".$row["sec"]."</td>\n";
            echo "<td>"."<a href='form_statis_score.php?cid=".$row["cid"]."&cname=".$row["cname"]."&cyear=".$row["year"]."&cterm=".$row["term"]."&csec=".$row["sec"]."'><img src='./image/statis_check.png' alt='สถิติการเข้าเรียน'  width='50' ></a>"."</td>\n";
